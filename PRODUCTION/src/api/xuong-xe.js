    ...
    try {
        ...
        const { recordset } = await new mssql.Request()
            ...
            .query(`INSERT INTO [prod].[XUONG_XE]
                    (ma, ten, dia_chi, mst, sdt, chung_chi, hieu_luc_cc, nguoi_dai_dien, chuc_vu, nguoi_nhan, mancc_woodsland)
                    OUTPUT INSERTED.*
                    VALUES (@ma, @ten, @dia_chi, @mst, @sdt, @chung_chi, @hieu_luc_cc, @nguoi_dai_dien, @chuc_vu, @nguoi_nhan, @mancc_woodsland)`)
